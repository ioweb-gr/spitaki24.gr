...
class Upgrade {
    ...
    /**
     * To show notice if backups are created on version less than 4.0.3
     */
    private function upgrade4_0_3()
    {
        // Previous version lower than 4.0.3 and greater than or equal to 4.0.0
        if (version_compare($this->previousVersion, '4.0.0', '>=') && version_compare($this->previousVersion, '4.0.3', '<')) {
