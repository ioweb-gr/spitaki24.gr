...
class ViewDDLOrder
{
    ...
    public function tryGetOrderedViews()
    {
        ...
        try {
            ...
            error_log('WPSTAGING Backup Create: Circular dependency when creating views dependency tree. ' . $e->getMessage());

            return $this->viewsToBeWritten;
        } catch (MissingReferenceException $e) {
                        error_log('WPSTAGING Backup Create: Missing Reference when creating views dependency tree. ' . $e->getMessage());
