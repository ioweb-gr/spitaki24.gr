...
/**
        ...
        echo '<div class="wordpress-gdpr-container">';
            echo '<div class="wordpress-gdpr-row">';
                echo '<div class="wordpress-gdpr-col-sm-6">';
                    ...
                    echo '<input class="wordpress-gdpr-input-field" name="gdpr_firstname" value="' . esc_attr( $gdpr_firstname ) . '" type="text">';
                echo '</div>';
            
                echo '<div class="wordpress-gdpr-col-sm-6">';
                    echo '<label for="gdpr_lastname">' . __( 'Last name', 'wordpress-gdpr' ) . '</label><br/>';
                    echo '<input class="wordpress-gdpr-input-field" name="gdpr_lastname" value="' . esc_attr( $gdpr_lastname ) . '" type="text">';
                echo '</div>';

                echo '<div class="wordpress-gdpr-col-sm-6">';
                    echo '<label for="gdpr_email">' . __( 'Email', 'wordpress-gdpr' ) . '</label><br/>';
                    echo '<input class="wordpress-gdpr-input-field" name="gdpr_email" value="' . esc_attr( $gdpr_email ) . '" type="text">';
                echo '</div>';
    ...
    public function save_custom_metaboxes($post_id, $post)
    {
        ...
        foreach ($possible_inputs as $possible_input) {
            $val = isset($_POST[$possible_input]) ? esc_html( $_POST[$possible_input] ) : '';
