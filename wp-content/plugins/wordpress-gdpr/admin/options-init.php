<?php
    ...
    $framework::setSection($opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                'id'       => 'consentModeV2',
                'type'     => 'checkbox',
                'title'    => __('Enable Google Consent Mode V2 Support', 'wordpress-gdpr'),
                'subtitle'    => __('Required since March 2024, before enabling read <a href="https://www.welaunch.io/en/knowledge-base/faq/wp-gdpr-google-consent-mode-v2/" target="_blank">this guide</a>.', 'wordpress-gdpr'),
                'default'  => '0',
            ),
            ...
            array(
                'id'       => 'version',
                'type'     => 'text',
                'title'    => __('Version', 'wordpress-gdpr'),
                'subtitle'    => __('Change the version when you modify or create services to update your users.', 'wordpress-gdpr'),
                'default'  => '1.0.0',
            ),
            array(
                'id'       => 'domainName',
            ...
            array(
                ...
                'desc' => '<div style="text-align:center;">' . __('This will create all pages, where no current assigned pages were found.', 'wordpress-gdpr') . '<br>
                    <a href="' . wp_nonce_url( get_admin_url() . 'admin.php?page=wordpress_gdpr_options_options&wordpress_gdpr[install-pages]=true' ) . '" class="button button-success">' . __('Install all Pages', 'wordpress-gdpr') . '</a>
                    </div>',
            ),
        )
    ));
        ...
        'fields'     => array(
            ...
            array(
                ...
                'desc' => '<div style="text-align:center;">
                    <a href="' . wp_nonce_url( get_admin_url() . 'admin.php?page=wordpress_gdpr_options_options&wordpress_gdpr[send-data-breach]=true') . '" class="button button-success">' . __('Send Data Breach Email', 'wordpress-gdpr') . '</a>
                    </div>',
                'required' => array('dataBreachEnable','equals','1'),
            ),
        )
    ...
    $framework::setSection($opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'type' => 'info',
                'desc' => '<div style="text-align:center;">
                    <a href="' . wp_nonce_url( get_admin_url() . 'admin.php?page=wordpress_gdpr_options_options&wordpress_gdpr[update-last-logged-in]=true') . '" class="button button-success">' . __('Update the "last logged in"-Meta with Todays Time for Users without an existing value.', 'wordpress-gdpr') . '</a>
                    </div>',
                'required' => array('dataRetentionEnable','equals','1'),
            ),
        )
   ...
   $framework::setSection($opt_name, array(
    ...
    $framework::setSection($opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'type' => 'info',
                'desc' => '<div style="text-align:center;">
                    <a href="' . wp_nonce_url( get_admin_url() . 'admin.php?page=wordpress_gdpr_options_options&wordpress_gdpr[send-privacy-policy-update]=true') . '" class="button button-success">' . __('Send Privacy Update Email', 'wordpress-gdpr') . '</a>
                    </div>',
                'required' => array('dataBreachEnable','equals','1'),
            ),
        )
    ...
    $framework::setSection($opt_name, array(
        ...
        'fields'     => array(
            array(
                'id'       => 'servicesGoogleTagManager',
                'type'     => 'switch',
                'title'    => __('Enable Google Tag Manager', 'wordpress-gdpr'),
                'subtitle' => __('Enable this when you use Google Tag Manager for all scripts. See this guide: ', 'wordpress-gdpr'),
                'default'  => '0',
            ),
            array(
                'id'       => 'servicesGoogleTagManagerCode',
                'type'     => 'ace_editor',
                'mode'     => 'javascript',
                'title'    => __('Tag Manager Head Code', 'wordpress-gdpr'),
                'default'  => '',
                'required' => array('servicesGoogleTagManager','equals','1'),
            ),
            array(
                'id'       => 'servicesGoogleTagManagerCodeBody',
                'type'     => 'ace_editor',
                'mode'     => 'javascript',
            ...
            array(
                ...
                'desc' => '<div style="text-align:center;">' . __('This will migrate all Service like Google Analytics etc to our new services section.', 'wordpress-gdpr') . '<br>
                    <a href="' . wp_nonce_url( get_admin_url() . 'admin.php?page=wordpress_gdpr_options_options&wordpress_gdpr[migrate-services]=true') . '" class="button button-success">' . __('Migrate Services', 'wordpress-gdpr') . '</a>
                    </div>',
            ),
            array(
