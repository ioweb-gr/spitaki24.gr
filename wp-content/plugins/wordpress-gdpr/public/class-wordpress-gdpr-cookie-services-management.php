...
class WordPress_GDPR_Cookie_Services_Management extends WordPress_GDPR
{
    ...
    public function get_services()
    {
        ...
        foreach ($services as $service) {
            $tmp[$service->ID] = array(
                ...
                'adwords' => get_post_meta($service->ID, 'adwords' , true),
                'analytics' => get_post_meta($service->ID, 'analytics' , true),
    ...
    public function check_privacy_setting() 
    {
        ...
        $allowed = isset($_COOKIE[$setting]) ? $_COOKIE[$setting] : false;
        $declined = false;
        $firstTime = false;
        ...
        //     setcookie('wordpress_gdpr_cookies_allowed', $allowed, $cookieLifetime, '/');
        //     setcookie('wordpress_gdpr_cookies_declined', 'false', $cookieLifetime, '/');
        // }
