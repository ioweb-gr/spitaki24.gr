...
class WordPress_GDPR_Public extends WordPress_GDPR
{
    ...
    public function enqueue_scripts()
    {
        ...
        $popupVersion = $this->get_option('version') ? $this->get_option('version') : '1.0.0';
        ...
        $forJS = array(
            ...
            'consentModeV2' => $this->get_option('consentModeV2'),
    ...
    public function tag_manager_head() 
    { 
        if(!$this->get_option('servicesGoogleTagManager')) {
            return;
        }

        echo $this->get_option('servicesGoogleTagManagerCode');
    }

    public function tag_manager_body() 
    { 
        if(!$this->get_option('servicesGoogleTagManager')) {
            return;
        }

        echo $this->get_option('servicesGoogleTagManagerCodeBody');
    }
