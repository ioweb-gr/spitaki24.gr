...
class WordPress_GDPR
{
    ...
    protected $data_delete;
    protected $data_breach;
    protected $policy_update;
    protected $install_pages;
    protected $data_retention;
    protected $consent_log;
    protected $services_post_type;
    protected $migrate_services;
    protected $term_order;
    protected $plugin_public;
    protected $cookie_popup;
    protected $cookie_service_management;
    ...
    private function define_public_hooks()
    {
        ...
        $this->loader->add_action('wp_head', $this->plugin_public, 'tag_manager_head');
        $this->loader->add_action('wp_body_open', $this->plugin_public, 'tag_manager_body');
